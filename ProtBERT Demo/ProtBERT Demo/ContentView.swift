                ...
                HStack{
                    ...
                    VStack(alignment: .leading){
                        Text("ProtBERT +  Core ML")
                            ...
                            .bold()
                            .padding(.bottom, 5)
                        Text("ProtBERT was trained to predict randomly-masked amino acids (AAs) across a corpus of over 217 million protein sequences. Enter a string of AA IDs to extract per-protein and per-residue features.")
                            .font(.callout)
                            .padding(.bottom)
                        Text("\(Image(systemName: "exclamationmark.triangle")) The converted Model Package has not been validated.")
                            .font(.caption2)
                            .padding(.bottom, 5)
                        Text("Martin C. 2023")
                            .font(.caption)
